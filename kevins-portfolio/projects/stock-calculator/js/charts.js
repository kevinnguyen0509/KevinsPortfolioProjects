...
$("#growth").click(function () {
  $("html, body").animate({ scrollTop: $("#growth-title").offset().top }, 1000);
});
...
let chart5 = new CanvasJS.Chart("chartContainer5", createDeepCopy(chartObject));
let chart6 = new CanvasJS.Chart("chartContainer6", createDeepCopy(chartObject));
let chart7 = new CanvasJS.Chart("chartContainer7", createDeepCopy(chartObject));
let chart8 = new CanvasJS.Chart("chartContainer8", createDeepCopy(chartObject));

let chart9 = new CanvasJS.Chart("chartContainer9", createDeepCopy(chartObject));
